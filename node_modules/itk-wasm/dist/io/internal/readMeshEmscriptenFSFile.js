...
function readMeshEmscriptenFSFile(emscriptenModule, filePath) {
    ...
    const meshType = new MeshType(ioDimensions, pointComponentType, pointPixelComponentType, pointPixelType, pointPixelComponents, cellComponentType, cellPixelComponentType, cellPixelType, cellPixelComponents);
