(function () {
  ...
  const ImageIOIndex = ['itkPNGImageIO', 'itkMetaImageIO', 'itkTIFFImageIO', 'itkNiftiImageIO', 'itkJPEGImageIO', 'itkNrrdImageIO', 'itkVTKImageIO', 'itkBMPImageIO', 'itkHDF5ImageIO', 'itkMINCImageIO', 'itkMRCImageIO', 'itkLSMImageIO', 'itkMGHImageIO', 'itkBioRadImageIO', 'itkGiplImageIO', 'itkGEAdwImageIO', 'itkGE4ImageIO', 'itkGE5ImageIO', 'itkGDCMImageIO', 'itkScancoImageIO', 'itkFDFImageIO', 'itkWASMImageIO', 'itkWASMZstdImageIO',];
  ...
  function availableIOModules(input) {
      return __asyncGenerator(this, arguments, function* availableIOModules_1() {
          for (let idx = 0; idx < ImageIOIndex$1.length; idx++) {
              const trialIO = ImageIOIndex$1[idx] + 'ReadImage';
